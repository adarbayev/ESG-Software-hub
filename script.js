...
let softwareData = [
    ...
    { id: 2, name: "Intelex ESG", logo: "assets/logos/intelex.png", owner_company: "Intelex Technologies", deployment_model: "SaaS", primary_purpose: "Data Management", description: "Intelex provides robust ESG data management capabilities, helping companies streamline data collection, improve accuracy, and meet reporting requirements. Its platform is known for its user-friendly interface and strong analytics features.", website: "https://www.intelex.com", starting_price: "$25,000/year", license_model: "Per User", analyst_rating: "Gartner: Challenger 2024", created_at: "2024-11-01", updated_at: "2025-05-01", mock_capability_score: 70, mock_momentum_score: 77 },
    ...
    { id: 12, name: "IBM Envizi Suite", logo: "assets/logos/envizi.png", owner_company: "IBM", deployment_model: "SaaS", primary_purpose: "Analytics", description: "IBM Envizi Suite provides data and analytics software for ESG performance management. It helps organizations capture, consolidate, manage, analyze, and report on their ESG data.", website: "https://www.ibm.com/products/envizi", starting_price: "Custom Quote", license_model: "Enterprise", analyst_rating: "Verdantix: Leader (ESG Reporting & Data Management)", created_at: "2024-06-15", updated_at: "2025-04-15", mock_capability_score: 82, mock_momentum_score: 72 }
];
